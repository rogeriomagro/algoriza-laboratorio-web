    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-30 border-b border-brand-forest/10 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-[1600px] flex-col gap-4 px-4 py-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex min-w-0 items-center gap-4 xl:flex-[1.15]">
            <LabBrand compact />
            <div className="min-w-0">
              <p className="text-[22px] font-semibold tracking-tight text-brand-forest">Validação de Orçamentos</p>
          ...
          <div className="flex flex-wrap items-center gap-2 xl:justify-end xl:flex-[1.05]">
            {realtimeState ? (
            ...
            <div className="rounded-xl border border-brand-emerald/15 bg-[linear-gradient(180deg,#f7fcfa_0%,#eff8f4_100%)] px-3 py-2 text-sm shadow-sm">
              <span className="block text-[11px] uppercase tracking-[0.08em] text-brand-forest/60">Validador atual</span>
              <span className="block font-semibold text-brand-forest">{validatorName || "Usuário sem nome configurado"}</span>
            </div>
